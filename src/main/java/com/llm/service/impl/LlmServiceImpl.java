...
public class LlmServiceImpl implements LlmService {
    ...
    private final ClothingAdviceTools clothingAdviceTools;
    ...
    public LlmServiceImpl(WeatherTools weatherTools,
                          ...
                          ClothingAdviceTools clothingAdviceTools) {
        ...
        this.clothingAdviceTools = clothingAdviceTools;
    }
    ...
    public String chat(String text, List<String> imageUrls, ChatClient client, String userId,
        ...
        try {
            ...
            var chatResponse = client.prompt()
                    ...
                    // 3. 把所有工具全部注册进去
                    .tools(weatherTools, imageTools, locationTools, translatorTools, voiceTools, imageAnalysisTool, clothingAdviceTools)
                    .call()
                    .chatResponse();
